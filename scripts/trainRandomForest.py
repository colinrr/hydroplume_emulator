...
monte_carlo_fixed_vars_file = join(DATA_DIR, 'KatlaHydro_v8_noLd_2024-06-30_N20000_fixed_MC_vars.mat')  # Simulation, table of fixed input parameters
...
grid_search_descriptor = 'GridSearch2'
...
# ----- Some data pre-processing and labeling -------
...
rft.plot_RF_scores(best_results, savefigs=True, descriptor=grid_search_descriptor)
